  ...
  (function(LoadBalancing) {
    ...
    var LoadBalancingClient = /** @class */ (function() {
      ...
      LoadBalancingClient.prototype.addRoom = function(r) {
        this.roomInfos.push(r); this.roomInfosDict[r.name] = r; 
      };
      LoadBalancingClient.prototype.clearRooms = function() {
        this.roomInfos = new Array(); this.roomInfosDict = {}; 
      };
    ...
    var NameServerPeer = /** @class */ (function(_super) {
      ...
      function NameServerPeer(client, protocol, address, subprotocol) {
        var _this = _super.call(this, protocol, address, subprotocol, 'NameServer') || this;
        _this.client = client;
        return _this;
      }
      // overrides
    ...
    var MasterPeer = /** @class */ (function(_super) {
      ...
      function MasterPeer(client, protocol, address, subprotocol) {
        var _this = _super.call(this, protocol, address, subprotocol, 'Master') || this;
        _this.client = client;
        return _this;
      }
      // overrides
    ...
    var GamePeer = /** @class */ (function(_super) {
      ...
      function GamePeer(client, protocol, address, subprotocol) {
        var _this = _super.call(this, protocol, address, subprotocol, 'Game') || this;
        _this.client = client;
        return _this;
      }
      // overrides
  ...
  (function(Chat) {
    ...
    var ChatClient = /** @class */ (function(_super) {
      ...
      ChatClient.prototype.subscribe = function(channelNames, messagesFromHistory) {
        if (messagesFromHistory === void 0) {
          messagesFromHistory = 0; 
        }
        if (this.isConnectedToFrontEnd()) {
          ...
          if (messagesFromHistory != undefined && messagesFromHistory != 0) {
            params.push(Chat.Constants.ParameterCode.HistoryLength, Photon.TypeExt.Int(messagesFromHistory));
          }
        ...
        if (this.isConnectedToFrontEnd()) {
          ...
          if (options) {
            if (options.webForward) {
              ...
              params.push(Photon.TypeExt.Byte(0x1));
            }
          }
